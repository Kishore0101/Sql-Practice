...
CREATE Table demo_technology(
    Id INT,
    technology VARCHAR(25)
);

#insert the id and technology to the table
INSERT INTO demo_technology VALUES(1,"python"),(1,"datascience"),(1,"sql"),(2,"python"),(2,"datascience"),(3,"datascience"),(3,"sql");
select * from demo_technology;

#select the list of id's who has all the required skills
select Id,COUNT(DISTINCT technology) as tech_count 
from demo_technology where technology in ("python","datascience","sql")
